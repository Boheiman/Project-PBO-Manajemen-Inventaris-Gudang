...
public class ManajemenPemasokImpl {
    ...
    private final String filePath = "datapemasok.csv"; // Updated file path
    ...
    private void muatDataDariFile() { 
        System.out.println("Mencoba memuat data dari file: " + filePath); // Log file loading attempt
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (data.length < 3) {
                    ...
                    continue; // Skip this line if data is incomplete
                }
